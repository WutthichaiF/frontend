...
export type Tool =
  ...
  | { kind: "place_formation_unit"; iconId: string; svg: string; thumb?: string; iconSize?: number }
  | { kind: "place_equipment_symbol"; iconId: string; thumb?: string; svg?: string; iconSize?: number };
type State = {
  tool: Tool;
  setTool: (t: Tool) => void;
};
